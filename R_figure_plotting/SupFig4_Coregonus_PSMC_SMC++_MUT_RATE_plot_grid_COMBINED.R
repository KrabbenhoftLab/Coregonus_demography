...
#all together now
plots <- plot_grid(a, e, f, j, k, o, p, r,
                   labels = "auto",
                   label_size = 12,
                   ncol = 2)
...
ggsave(paste(wdII, "./", "SupFigX_Coregonus_PSMC_SMC_mut_rate_plot_grid_combined_12-1-23", ".png", sep=""), plot=plots, units = "in", dpi=1000, height=15, width=12)
ggsave(paste(wdII, "./", "SupFigX_Coregonus_PSMC_SMC_mut_rate_plot_grid_combined_12-1-23", ".svg", sep=""), plot=plots, units = "in", dpi=1000, height=15, width=12)
