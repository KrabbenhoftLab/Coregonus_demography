#!/bin/sh
HOME="/mnt/krab1/NJCB_data/Snamaycush_PSMC_v2/PSMC_param7_bootstrap_raw_bam"
cd ${HOME}
FILELIST=`cat temp`
...
/home/krablab/Documents/apps/psmc/utils/psmc_plot.pl -u 7.26e-09 -g 16 -w 5 -R ${f}_param7_g16_u7.26e-09_bootstrap_100 ${f}.combined.psmc 

######
mkdir -p filtered_column
awk '{print $1, $2}' ${f}_param7_g16_u7.26e-09_bootstrap_100.0.txt > ./filtered_column/${f}_param7_shared_bootstrap_100_g16_7.26e-09_original.txt
...
paste -d' ' ./labels/${f}_label.txt ${f}_param7_shared_bootstrap_100_g16_7.26e-09_original.txt > ${f}_main_data.txt
