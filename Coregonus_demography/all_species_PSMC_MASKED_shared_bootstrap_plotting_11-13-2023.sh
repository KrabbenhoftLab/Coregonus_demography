#!/bin/sh
HOME="/mnt/krab1/NJCB_data/Coregonus_PSMC_v2/PSMC_masked_param7_bootstrap_raw_bam"
cd ${HOME}
FILELIST=`cat temp`
...
/home/krablab/Documents/apps/psmc/utils/psmc_plot.pl -u 7.26e-09 -g 6 -w 5 -R ${f}_param7_g6_u7.26e-09_bootstrap_100 ${f}.combined.psmc 
