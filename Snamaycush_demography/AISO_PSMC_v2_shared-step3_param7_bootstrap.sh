...
OUT="/mnt/krab1/NJCB_data/Snamaycush_PSMC_v2/PSMC_param7_bootstrap_raw_bam"
mkdir -p ${OUT}
cd ${OUT}
#STEP 3: Run PSMC:
for f in ${FILELIST}
...
seq 100 | xargs -t -n 1 -P 15 -i ${PSMCDIR}/psmc -N25 -t5 -r5 -b -p "4+20*2+6*4+4" -o ${f}_round-{}.psmc ${f}.split.psmcfa | sh
